...
if __name__ == "__main__":
    ...
    # b = 1
    # for v1, v2 in minibatch_iterator(X_tr, Y_tr, 300):
    ...
    # use this to load the parameter weights either into Lasagne or into
    # numpy arrays to plot as images
    # we want to see what the kernels learn over the 100 epochs
